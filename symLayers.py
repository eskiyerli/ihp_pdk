...
stretchSymbolLayer = replace(
    symbolLayer, name="stretchSymbol", pcolor=QColor("red"), z=2
)
selectedSymbolLayer = replace(
    symbolLayer, name="selectedSymbol", pcolor=QColor("blue"), z=3
)

symbolPinLayer = ddef.edLayer(
    name="symbolPin",
    pcolor=QColor("red"),
    pwidth=1,
    z=2,
...
selectedSymbolPinLayer = replace(
...
labelLayer = ddef.edLayer(
    ...
    pwidth=1,
    z=5,
    # bcolor=QColor(Qt.darkYellow),
    bcolor=QColor(218, 165, 32),  # Using goldenrod color instead of darkYellow
    bstyle=Qt.SolidPattern,
    visible=True,
    selectable=True,
)
selectedLabelLayer = replace(
    labelLayer,
    name="selectedLabel",
    pcolor=QColor("yellow"),
    z=6,
...
selectedSymbolPen = QPen(
    selectedSymbolLayer.pcolor, selectedSymbolLayer.pwidth, selectedSymbolLayer.pstyle
)

symbolPinPen = QPen(symbolPinLayer.pcolor, symbolPinLayer.pwidth, symbolPinLayer.pstyle)

selectedSymbolPinPen = QPen(
    selectedSymbolPinLayer.pcolor,
